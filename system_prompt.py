...
2.  **Owner Identification:** The 'owner' must be the specific name of the person who committed to the task. If no specific name is mentioned but the context implies a team (e.g., "The marketing team will..."), use the team name (e.g., "Marketing Team"). If no owner is identifiable, set 'owner' to "UNASSIGNED".
